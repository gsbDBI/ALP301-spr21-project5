...
When you look at the data, you may note another variable of potential interest in examining basic facts of all users: age. We do not consider that variable because most (~85.5%) users are missing this information. 
...
# Filter out users who created an account after Nov 1st, 2020 
filtered_logged_df_nov <- filtered_logged_df_nov %>%
  dplyr::filter(!(child_id_code %in% pre_may_users))
...
# number of days to string so we can have tha last label as 10+ and
