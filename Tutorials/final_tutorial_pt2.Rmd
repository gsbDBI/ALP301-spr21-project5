...
user_num_and_max_sessions<-filtered_logged_df %>%
  ...
  group_by(child_id) %>%
  dplyr::summarize(max_days_since_signup = max(days_since_signup),num_days_active=n(),prop_active=n()/max(days_since_signup))
...
# if we don't standardize max_days_since_signup and prop_active
